...
本 wiki 反映的是 2026 年初开源 GPU 推理生态的状态。具体的内核库版本号（CUTLASS 3.x、sglang 0.5.x、FlashInfer 0.6.x）和 PTX ISA 版本（8.5）在正文中要紧的地方都已固定标明。凡是写着"截至 2026 年"的内容，都请当作一个快照，而不是永久成立的事实——这些库每隔几周就会变。
